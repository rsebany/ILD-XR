...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--weights",
        default=None,
        help="Optional explicit weights path. Defaults to backend-api/weights/best_multiclass_model.pth.",
    )
    parser.add_argument(
        "--min-volume-ml",
        type=float,
...
def main() -> None:
    ...
    backend_api_dir = script_dir.parent
    project_root = backend_api_dir.parent

    # Make backend-api package imports work when run as a script.
