...
export function View3DReconstructionPanel() {
  ...
  /** Prefer anatomical “Real lung” look by default. */
  const [lungRenderMode, setLungRenderMode] = useState<LungRenderMode>("real");
...
const ZONE_META: Record<ZoneFilter, { label: string }> = {
  all: { label: "All Zones" },
  upper: { label: "Upper" },
  middle: { label: "Middle" },
  lower: { label: "Lower" },
